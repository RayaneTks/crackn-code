...
export const levels: Record<string, Level[]> = {
  html: [
    ...
    },
    {
      ...
      // JEU À INTÉGRER : Mini-jeu de Flexbox
      // Notions attendues : display: flex, flex-direction, justify-content, align-items, gap
      // Exemple de défi : Réorganiser des boîtes, centrer des éléments, créer une barre de navigation.
    },
    {
      id: "html-lvl-3",
      languageId: "html",
      ...
      // JEU À INTÉGRER : Mini-jeu de CSS Grid
      // Notions attendues : display: grid, grid-template-columns, grid-template-rows, grid-gap, grid-area
      // Exemple de défi : Créer une galerie d'images, un layout de blog avec sidebar.
    },
    {
      id: "html-lvl-4",
      languageId: "html",
      ...
      // JEU À INTÉGRER : Mini-jeu de Responsive Design
      // Notions attendues : @media, max-width, min-width, viewport, unités relatives (%, vw, vh)
      // Exemple de défi : Adapter un layout pour mobile, cacher/afficher des éléments selon la taille d'écran.
    },
    {
      id: "html-lvl-5",
      languageId: "html",
      ...
      // JEU À INTÉGRER : Mini-jeu d'Animations et Accessibilité
      // Notions attendues : @keyframes, animation, transition, transform, aria-label, rôle sémantique
      // Exemple de défi : Animer un bouton, créer un loader, rendre un formulaire accessible.
    },
  ],
  javascript: [
    {
